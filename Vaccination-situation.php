                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header border-bottom mt-4">
                            <h4 class="card-title mb-0 text-center mt-3">এক নজরে উপজেলার টিকা চিত্র ( ১২ বছর অথবা তদূর্ধ্ব সকল নাগরিক )</h4>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-header border-bottom mt-4">
                            <h4 class="text-center card-title mb-0">এক নজরে ইউনিয়ন সমূহের টিকা চিত্র ( ১২ বছর অথবা তদূর্ধ্ব সকল নাগরিক )</h4>
                        </div>
                        <div class="card-body analytics-info">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom mt-4">
                            <h4 class="text-center card-title mb-0">এক নজরে ইউনিয়ন সমূহের টিকা চিত্র ( ১২ বছর অথবা তদূর্ধ্ব সকল নাগরিক ) - শতকরা হার</h4>
                        </div>
                        <div class="card-body analytics-info">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom mt-4">
                            <h4 class="text-center card-title mb-0">টিকা অপ্রাপ্ত এবং প্রথম ডোজ সম্পূর্ণদের বয়স ভিত্তক বিন্যাস</h4>
                        </div>
                        <div class="card body analytics-info">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom mt-4">
                            <h4 class="text-center card-title mb-0">প্রথম ডোজ সম্পূর্ণদের বয়স ভিত্তক বিন্যাস - ইউনিয়ন অনুসারে</h4>
                        </div>
                        <div class="card-body analytics-info">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom mt-4">
                            <h4 class="text-center card-title mb-0">এক নজরে টিকার ধরন অনুযায়ী শ্রেনী বিন্যাস - প্রথম ডোজ</h4>
                        </div>
                        <div class="card-body analytics-info">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom mt-4">
                            <h4 class="text-center card-title mb-0">এক নজরে টিকার ধরন অনুযায়ী শ্রেনী বিন্যাস - দ্বিতীয় ডোজ</h4>
                        </div>
                        <div class="card-body analytics-info">
                    ...
                    <div class="card">
                        <div class="card-header border-bottom mt-4">
                            <h4 class="text-center card-title mb-0">দৈনিক নিবন্ধনের হালনাগাদ হার প্রথম ডোজ এবং দ্বিতীয় ডোজ</h4>
                        </div>
                        <div class="card-body analytics-info">

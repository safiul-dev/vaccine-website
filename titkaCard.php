...
<html lang="en">
    ...
    <body>
            ...
            <div class="left-wrepper">
                ...
                <div class="tika-form">
                    <div class="form-group">
                        <div class="label-div">
                            <label class="form-label" style="" for="">জাতীয় পরিচয়পত্র/জন্মনিবন্দন/পাসপোর্ট নম্বর</label>
                        </div>
                        <div class="input-div">
                            <input type="text" id="identify_id" class="form-control">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="label-div-kendro">
                            <label class="form-label" id="subcenter" for="">কেন্দ্রের নাম</label>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-div-name">
                            <input type="text" id="donner_name" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-div-mobile">
                            <input type="text" id="donner_phone" class="form-control">
                        </div>
                    </div>
                        ...
                        <table class="">
                            ...
                            <tbody>
                                <tr class="table-body-tr">
                                    <th scope="row">কোভিড ১৯ টিকা- ১ম ডোজ</th>
                                    <td class="table_td" rowspan="1"><span id="1st-dose-date"></span></td>
                                    <td class="table_td" rowspan="1"><span id="1st-dose-sign"></span></td>
                                </tr>
                                <tr class="table-body-tr">
                                    <th scope="row">কোভিড ১৯ টিকা- ২য় ডোজ</th>
                                    <td class="table_td" rowspan="1">
                                        <span id="2nd-dose-date"></span>
                                    </td>
                                    <td class="table_td" rowspan="1">
                                        <span id="2nd-dose-sign"></span></td>
                                    </td>
                                </tr>
                                <tr class="table-body-tr">
                                    ...
                                    <td class="table_bottom_td" colspan="2">
                                        <div class="rd_td_wrapper_main">
                                            ...
                                            <div class="rd_td_wrapper">
                                                <p>ডোজ - ১ : <span id="vaccine-name1"></span> </p>
                                            </div>
                                            <div class="rd_td_wrapper_bottom">
                                                <p>ডোজ - ২ : <span id="vaccine-name2"></span></p>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="right-wrepper">
                ...
                <div class="text">
                    ...
                    <div class="text-inner-div">
                        ...
                        <div>
                            <p class="text-p">কোভিড-১৯ টিকা নেয়ার জন্য নির্ধিষ্ট তারিকে নির্ধিষ্ট টিকাদান কেন্দ্রে এই টীকার কার্ডটি সাথে নিয়ে আসুন।</p>
                        </div>
                    </div>
                    <div class="text-inner-div">
                        <div class="text-angle">></div>
        ...
        <script src="./custom-script/cardPrint.js">
        </script>
    </body>

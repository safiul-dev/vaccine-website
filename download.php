...
<html lang="en">
    ...
    <body>
            ...
            <div class="top_header">
                <div class="container-fluid">
                    <div class="row align_items_cmn">
                        <div class="col-sm-2">
                            <div class="left_logo">
                                <a href="./index.php"> <img src="assest/img/covid/gob logo.png" alt=""></a>
                            </div>
                        </div>
                        <div class="col-sm-8">
                        ...
                        <div class="container-fluid">
                            <div class="tab_content_area">
                                ...
                                <ul class="nav nav-tabs custom_tab_menu" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="false">জন্ম
                                        নিবন্ধনসনদ
                                    </button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        ...
                                        <div class="tab_content_area_s">
                                                ...
                                                <form action="#" id="submit">
                                                    ...
                                                    <div class="input_content">
                                                        <div class="single_input half_one">
                                                            ...
                                                            <input type="text" id="nid_no" placeholder="উদাহরণঃ ২০০২১৬৪৯৪৫৬৯৭৪৬১২">
                                                        </div>
                                                        <div class="single_input half_one">
                                                    ...
                                                    <div class="submit_btn_area">
                                                        <button class=" big_form_submit_btn">যাচাই করুন & OTP নিন</button>
                                                    </div>
                                                </form>
                                            </div>
                                            <div class="down_sucess">
                                                ...
                                                <div class="otp_box_in">
                                                    <div class="download_form_area">
                                                        <form action="#" id="nid-vaccine-card">

                                                            <div class="input_content">
                                                                <div class="single_input ">
                                                                    <label for="Name">OTP প্রদান করুন</label>
                                                                    <input type="text" id="nid-otp">
                                                                </div>
                                                            </div>
                                                            <div class="submit_btn_area">
                                                                <button type="submit" class=" big_form_submit_btn ">টিকা কার্ড ডাউনলোড
                                                                    করুন</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                        ...
                                        <div class="tab_content_area_s ">
                                            ...
                                            <div class="down_sucess ">
                                                <h2>
                                                    ...
                                                    <div class="otp_box_in ">
                                                        <div class="download_form_area ">
                                                            <form action="# " id="birth-vaccine-card">
                                                                <div class="input_content ">
                                                                    <div class="single_input ">
                                                                        <label for="Name ">OTP No</label>
                                                                        <input type="text " id="birth-otp ">
                                                                    </div>
                                                                </div>
                                                                <div class="submit_btn_area ">
                                                                    <button type="submit" class=" big_form_submit_btn ">টিকা কার্ড ডাউনলোড
                                        ...
                                        <div class="tab_content_area_s ">
                                            ...
                                            <div class=" down_sucess ">
                                                <h2>
                                                    ...
                                                    <div class="otp_box_in ">
                                                        <div class="download_form_area ">
                                                            <form action="# " id="passport-vaccine-card ">
                                                                <div class="input_content ">
                                                                    <div class="single_input ">
                                                                        <label for="Name ">OTP No</label>
        ...
        <script src="./custom-script/print.js "></script>
        <script src="./custom-script/download.js "></script>
    </body>

$(document).ready(function() {
    var basicpieChart = echarts.init(document.getElementById('pie3'));
    ...
    function piechartOptions(res) {
        basicpieChart.setOption({
            ...
            // Add custom colors
            color: ['#71B9E4', '#53A779', '#E25D3C', '#8A8E05', '#595B03', '#1B66CA', '#C70039', '#083C90'],
    ...
    $.ajax({
        url: "https://uno.covidvaccination-brahmanpara.gov.bd/pie-chart-data-tika2",
        type: 'get',

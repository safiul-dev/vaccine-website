                        ...
                        <div class="container-fluid">
                            <div class="tab_content_area">
                                ...
                                <ul class="nav nav-tabs custom_tab_menu" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="contact-tab" data-bs-toggle="tab" data-bs-target="#contact" type="button" role="tab" aria-controls="contact" aria-selected="false"> মোবাইল নাম্বার
                                        </button>
                                    </li>
                                </ul>
                                <!-- tab menu end  -->
                                ...
                                <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="download_form_area">
                                                <form action="#">
                                                    <div class="input_content">
                                                        ...
                                                        <div class="single_input half_one">
                                                            <label for="birty">জন্ম তারিখ (নিবন্ধনসনদ পরিচয়পত্র অনুযায়ী):</label>
                                                            <div class="bir_3_area">
                                                                <div class="birtdy_3">
                                                                    <input type="text" id="day" placeholder="দিন ">
                                                                </div>
                                            ...
                                            <div class="download_form_area">
                                                <form action="#">
                                                    <div class="input_content">
                                                        ...
                                                        <div class="single_input half_one">
                                                            <label for="birty">জন্ম তারিখ (পাসপোর্ট পরিচয়পত্র অনুযায়ী):</label>
                                                            <div class="bir_3_area">
                                                                <div class="birtdy_3">
                                                                    <input type="text" id="day" placeholder="দিন ">
                                                                </div>
                                    ...
                                    <div class="tab-pane fade cmn_for_tab_content" id="contact" role="tabpanel" aria-labelledby="contact-tab">
